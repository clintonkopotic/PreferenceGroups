...
{
    /// <summary>
    /// An <see cref="ushort"/> <see cref="Preference"/>.
    /// </summary>
    public class UInt16Preference : StructPreference<ushort>
    {
        /// <summary>
        ...
        /// method.
        /// </summary>
        /// <param name="name">The name of the <see cref="UInt16Preference"/>
        ...
        public UInt16Preference(string name) : base(name)
        { }
        ...
        /// empty <see langword="string"/> or conists only of white-space
        /// characters.</exception>
        public UInt16Preference(string name, string description,
            bool allowUndefinedValues,
            IEnumerable<ushort?> allowedValues,
            StructValidityProcessor<ushort> validityProcessor)
        ...
        /// characters.</exception>
        public UInt16Preference(string name, string description,
            bool allowUndefinedValues, IEnumerable<ushort?> allowedValues,
        ...
        /// <see cref="ushort"/>. If <paramref name="value"/> is
        ...
        public override ushort? ConvertObjectToValue(object value)
        ...
        /// <exception cref="SetValueException">An exception was thrown while
        /// converting.</exception>
        public static ushort? ConvertObjectToValueBase(object value)
        {
            if (value is null)
            {
                return null;
