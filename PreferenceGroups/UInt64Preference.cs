...
{
    /// <summary>
    /// An <see cref="ulong"/> <see cref="Preference"/>.
    /// </summary>
    public class UInt64Preference : StructPreference<ulong>
    {
        /// <summary>
        ...
        /// method.
        /// </summary>
        /// <param name="name">The name of the <see cref="UInt64Preference"/>
        ...
        public UInt64Preference(string name) : base(name)
        { }
        ...
        /// empty <see langword="string"/> or conists only of white-space
        /// characters.</exception>
        public UInt64Preference(string name, string description,
            bool allowUndefinedValues,
            IEnumerable<ulong?> allowedValues,
            StructValidityProcessor<ulong> validityProcessor)
        ...
        /// characters.</exception>
        public UInt64Preference(string name, string description,
            bool allowUndefinedValues, IEnumerable<ulong?> allowedValues,
        ...
        /// <see cref="ulong"/>. If <paramref name="value"/> is
        ...
        public override ulong? ConvertObjectToValue(object value)
        ...
        /// <exception cref="SetValueException">An exception was thrown while
        /// converting.</exception>
        public static ulong? ConvertObjectToValueBase(object value)
        {
            if (value is null)
            {
                return null;
