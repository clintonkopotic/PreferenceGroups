...
namespace PreferenceGroups
{
    ...
    /// <see cref="UInt16Preference"/>.
    /// </summary>
    public class UInt16PreferenceBuilder
    {
        ...
        private ushort? _defaultValue = null;

        private List<ushort?> _allowedValues = null;

        private bool _allowUndefinedValues = true;

        private bool _sortAllowedValues = false;

        private StructValidityProcessor<ushort> _validityProcessor
            = new StructValidityProcessor<ushort>();

        private UInt16PreferenceBuilder() { }

        /// <summary>
        /// Specifies that only values defined by the
        /// <see cref="WithAllowedValues(ushort?[])"/> methods (or related
        /// methods) will be allowed.<br/>
        /// <b>NOTE</b>: If <see cref="WithAllowedValues(ushort?[])"/> is not
        ...
        /// </summary>
        /// <returns></returns>
        public UInt16PreferenceBuilder AllowOnlyDefinedValues()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public UInt16PreferenceBuilder AllowUndefinedValues()
        {
        ...
        /// <summary>
        /// Builds the <see cref="UInt16Preference"/>.
        /// </summary>
        /// <returns></returns>
        public UInt16Preference Build() =>
            new UInt16Preference(_name, _description, _allowUndefinedValues,
        ...
        /// </summary>
        /// <returns></returns>
        public UInt16PreferenceBuilder DoNotSortAllowedValues()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public UInt16PreferenceBuilder SetAllowUndefinedValues(
        ...
        /// </summary>
        /// <returns></returns>
        public UInt16PreferenceBuilder SetSortAllowedValues(
        ...
        /// <returns></returns>
        public UInt16PreferenceBuilder SetValidityProcessor(
            UInt16ValidityProcessor processor)
            => SetValidityProcessor((StructValidityProcessor<ushort>)processor);
        ...
        /// <returns></returns>
        public UInt16PreferenceBuilder SetValidityProcessor(
            StructValidityProcessor<ushort> processor)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public UInt16PreferenceBuilder SortAllowedValues()
        {
        ...
        public UInt16PreferenceBuilder WithAllowedValues(
            IEnumerable<ushort?> allowedValues)
        {
            ...
            _allowedValues = new List<ushort?>(allowedValues);
        ...
        /// <see cref="UInt16Preference.ConvertObjectToValueBase(object)"/>
            ...
            IEnumerable<object> allowedValues)
        {
            ...
            foreach (var allowedValue in allowedValues)
            {
                try
                {
                    var value = UInt16Preference.ConvertObjectToValueBase(
                        allowedValue);
            ...
            params ushort?[] allowedValues)
        {
            ...
            return WithAllowedValues((IEnumerable<ushort?>)allowedValues);
        }
        ...
        /// <paramref name="allowedValues"/> is
        /// <see langword="null"/>.</exception>
        public UInt16PreferenceBuilder WithAllowedValuesAndDoNotSort(
            IEnumerable<ushort?> allowedValues)
        {
            if (allowedValues is null)
            {
        ...
        /// <paramref name="allowedValues"/> is
        /// <see langword="null"/>.</exception>
        public UInt16PreferenceBuilder WithAllowedValuesAndSort(
            IEnumerable<ushort?> allowedValues)
        {
            if (allowedValues is null)
            {
            ...
            params ushort?[] allowedValues)
        {
            ...
            return WithAllowedValuesAndSort((IEnumerable<ushort?>)allowedValues);
        }
        ...
        /// <returns></returns>
        public UInt16PreferenceBuilder WithDefaultValue(ushort? defaultValue)
        {
        ...
        /// <returns></returns>
        public UInt16PreferenceBuilder WithDescription(string description)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public UInt16PreferenceBuilder WithNoAllowedValues()
        {
            _allowedValues = null;
        ...
        public UInt16PreferenceBuilder WithValidityProcessor(
            UInt16ValidityProcessor processor)
        {
        ...
        /// <returns></returns>
        public UInt16PreferenceBuilder WithValue(ushort? value)
        {
            _value = value;
        ...
        /// <returns></returns>
        public UInt16PreferenceBuilder WithValueAndAsDefault(
            ushort? valueAndAsDefault)
            => WithValue(valueAndAsDefault)
                .WithDefaultValue(valueAndAsDefault);

        /// <summary>
        /// Builds a <see cref="UInt16Preference"/> with
        ...
        /// <see langword="null"/>.</exception>
        public static UInt16Preference Build(string name)
        ...
        /// <exception cref="ArgumentNullException"><paramref name="name"/> is
        /// <see langword="null"/>.</exception>
        public static UInt16Preference Build(string name, ushort? value)
            => Create(Preference.ProcessNameOrThrowIfInvalid(name,
                    nameof(name)))
                .WithValue(value)
                .Build();
        ...
        /// <summary>
        /// Creates a <see cref="UInt16PreferenceBuilder"/> with
        /// <paramref name="name"/> (after it is processed with
        /// <see cref="Preference.ProcessNameOrThrowIfInvalid(string,
        /// string)"/>).
        /// </summary>
        ...
        /// <exception cref="ArgumentNullException"><paramref name="name"/> is
        /// <see langword="null"/>.</exception>
        public static UInt16PreferenceBuilder Create(string name)
            => new UInt16PreferenceBuilder()
            {
