...
namespace PreferenceGroups
{
    ...
    /// <see cref="UInt32Preference"/>.
    /// </summary>
    public class UInt32PreferenceBuilder
    {
        ...
        private uint? _defaultValue = null;

        private List<uint?> _allowedValues = null;

        private bool _allowUndefinedValues = true;

        private bool _sortAllowedValues = false;

        private StructValidityProcessor<uint> _validityProcessor
            = new StructValidityProcessor<uint>();

        private UInt32PreferenceBuilder() { }

        /// <summary>
        /// Specifies that only values defined by the
        /// <see cref="WithAllowedValues(uint?[])"/> methods (or related
        /// methods) will be allowed.<br/>
        /// <b>NOTE</b>: If <see cref="WithAllowedValues(uint?[])"/> is not
        ...
        /// </summary>
        /// <returns></returns>
        public UInt32PreferenceBuilder AllowOnlyDefinedValues()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public UInt32PreferenceBuilder AllowUndefinedValues()
        {
        ...
        /// <summary>
        /// Builds the <see cref="UInt32Preference"/>.
        /// </summary>
        /// <returns></returns>
        public UInt32Preference Build() =>
            new UInt32Preference(_name, _description, _allowUndefinedValues,
        ...
        /// </summary>
        /// <returns></returns>
        public UInt32PreferenceBuilder DoNotSortAllowedValues()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public UInt32PreferenceBuilder SetAllowUndefinedValues(
        ...
        /// </summary>
        /// <returns></returns>
        public UInt32PreferenceBuilder SetSortAllowedValues(
        ...
        /// <returns></returns>
        public UInt32PreferenceBuilder SetValidityProcessor(
            UInt32ValidityProcessor processor)
            => SetValidityProcessor((StructValidityProcessor<uint>)processor);
        ...
        /// <returns></returns>
        public UInt32PreferenceBuilder SetValidityProcessor(
            StructValidityProcessor<uint> processor)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public UInt32PreferenceBuilder SortAllowedValues()
        {
        ...
        public UInt32PreferenceBuilder WithAllowedValues(
            IEnumerable<uint?> allowedValues)
        {
            ...
            _allowedValues = new List<uint?>(allowedValues);
        ...
        /// <see cref="UInt32Preference.ConvertObjectToValueBase(object)"/>
            ...
            IEnumerable<object> allowedValues)
        {
            ...
            foreach (var allowedValue in allowedValues)
            {
                try
                {
                    var value = UInt32Preference.ConvertObjectToValueBase(
                        allowedValue);
            ...
            params uint?[] allowedValues)
        {
            ...
            return WithAllowedValues((IEnumerable<uint?>)allowedValues);
        }
        ...
        /// <paramref name="allowedValues"/> is
        /// <see langword="null"/>.</exception>
        public UInt32PreferenceBuilder WithAllowedValuesAndDoNotSort(
            IEnumerable<uint?> allowedValues)
        {
            if (allowedValues is null)
            {
        ...
        /// <paramref name="allowedValues"/> is
        /// <see langword="null"/>.</exception>
        public UInt32PreferenceBuilder WithAllowedValuesAndSort(
            IEnumerable<uint?> allowedValues)
        {
            if (allowedValues is null)
            {
            ...
            params uint?[] allowedValues)
        {
            ...
            return WithAllowedValuesAndSort((IEnumerable<uint?>)allowedValues);
        }
        ...
        /// <returns></returns>
        public UInt32PreferenceBuilder WithDefaultValue(uint? defaultValue)
        {
        ...
        /// <returns></returns>
        public UInt32PreferenceBuilder WithDescription(string description)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public UInt32PreferenceBuilder WithNoAllowedValues()
        {
            _allowedValues = null;
        ...
        public UInt32PreferenceBuilder WithValidityProcessor(
            UInt32ValidityProcessor processor)
        {
        ...
        /// <returns></returns>
        public UInt32PreferenceBuilder WithValue(uint? value)
        {
            _value = value;
        ...
        /// <returns></returns>
        public UInt32PreferenceBuilder WithValueAndAsDefault(
            uint? valueAndAsDefault)
            => WithValue(valueAndAsDefault)
                .WithDefaultValue(valueAndAsDefault);

        /// <summary>
        /// Builds a <see cref="UInt32Preference"/> with
        ...
        /// <see langword="null"/>.</exception>
        public static UInt32Preference Build(string name)
        ...
        /// <exception cref="ArgumentNullException"><paramref name="name"/> is
        /// <see langword="null"/>.</exception>
        public static UInt32Preference Build(string name, uint? value)
            => Create(Preference.ProcessNameOrThrowIfInvalid(name,
                    nameof(name)))
                .WithValue(value)
                .Build();
        ...
        /// <summary>
        /// Creates a <see cref="UInt32PreferenceBuilder"/> with
        /// <paramref name="name"/> (after it is processed with
        /// <see cref="Preference.ProcessNameOrThrowIfInvalid(string,
        /// string)"/>).
        /// </summary>
        ...
        /// <exception cref="ArgumentNullException"><paramref name="name"/> is
        /// <see langword="null"/>.</exception>
        public static UInt32PreferenceBuilder Create(string name)
            => new UInt32PreferenceBuilder()
            {
