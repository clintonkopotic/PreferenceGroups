...
namespace PreferenceGroups
{
    ...
    /// <see cref="Int64Preference"/>.
    /// </summary>
    public class Int64PreferenceBuilder
    {
        ...
        private List<long?> _allowedValues = null;

        private bool _allowUndefinedValues = true;

        private bool _sortAllowedValues = false;

        private StructValidityProcessor<long> _validityProcessor
            = new StructValidityProcessor<long>();

        private Int64PreferenceBuilder() { }

        /// <summary>
        /// Specifies that only values defined by the
        /// <see cref="WithAllowedValues(long?[])"/> methods (or related
        /// methods) will be allowed.<br/>
        /// <b>NOTE</b>: If <see cref="WithAllowedValues(long?[])"/> is not
        ...
        /// </summary>
        /// <returns></returns>
        public Int64PreferenceBuilder AllowOnlyDefinedValues()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Int64PreferenceBuilder AllowUndefinedValues()
        {
        ...
        /// <summary>
        /// Builds the <see cref="Int64Preference"/>.
        /// </summary>
        /// <returns></returns>
        public Int64Preference Build() =>
            new Int64Preference(_name, _description, _allowUndefinedValues,
        ...
        /// </summary>
        /// <returns></returns>
        public Int64PreferenceBuilder DoNotSortAllowedValues()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Int64PreferenceBuilder SetAllowUndefinedValues(
        ...
        /// </summary>
        /// <returns></returns>
        public Int64PreferenceBuilder SetSortAllowedValues(
        ...
        /// <returns></returns>
        public Int64PreferenceBuilder SetValidityProcessor(
            Int64ValidityProcessor processor)
            => SetValidityProcessor((StructValidityProcessor<long>)processor);
        ...
        /// <returns></returns>
        public Int64PreferenceBuilder SetValidityProcessor(
            StructValidityProcessor<long> processor)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Int64PreferenceBuilder SortAllowedValues()
        {
        ...
        public Int64PreferenceBuilder WithAllowedValues(
            IEnumerable<long?> allowedValues)
        {
            ...
            _allowedValues = new List<long?>(allowedValues);
        ...
        /// <see cref="Int64Preference.ConvertObjectToValueBase(object)"/>
            ...
            IEnumerable<object> allowedValues)
        {
            ...
            foreach (var allowedValue in allowedValues)
            {
                try
                {
                    var value = Int64Preference.ConvertObjectToValueBase(
                        allowedValue);
            ...
            params long?[] allowedValues)
        {
            ...
            return WithAllowedValues((IEnumerable<long?>)allowedValues);
        }
        ...
        /// <paramref name="allowedValues"/> is
        /// <see langword="null"/>.</exception>
        public Int64PreferenceBuilder WithAllowedValuesAndDoNotSort(
            IEnumerable<long?> allowedValues)
        {
            if (allowedValues is null)
            {
        ...
        /// <paramref name="allowedValues"/> is
        /// <see langword="null"/>.</exception>
        public Int64PreferenceBuilder WithAllowedValuesAndSort(
            IEnumerable<long?> allowedValues)
        {
            if (allowedValues is null)
            {
            ...
            params long?[] allowedValues)
        {
            ...
            return WithAllowedValuesAndSort((IEnumerable<long?>)allowedValues);
        }
        ...
        /// <returns></returns>
        public Int64PreferenceBuilder WithDefaultValue(long? defaultValue)
        {
        ...
        /// <returns></returns>
        public Int64PreferenceBuilder WithDescription(string description)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Int64PreferenceBuilder WithNoAllowedValues()
        {
            _allowedValues = null;
        ...
        public Int64PreferenceBuilder WithValidityProcessor(
            Int64ValidityProcessor processor)
        {
        ...
        /// <returns></returns>
        public Int64PreferenceBuilder WithValue(long? value)
        {
            _value = value;
        ...
        /// <returns></returns>
        public Int64PreferenceBuilder WithValueAndAsDefault(
            long? valueAndAsDefault)
            => WithValue(valueAndAsDefault)
                .WithDefaultValue(valueAndAsDefault);

        /// <summary>
        /// Builds a <see cref="Int64Preference"/> with
        ...
        /// <see langword="null"/>.</exception>
        public static Int64Preference Build(string name)
        ...
        /// <exception cref="ArgumentNullException"><paramref name="name"/> is
        /// <see langword="null"/>.</exception>
        public static Int64Preference Build(string name, long? value)
            => Create(Preference.ProcessNameOrThrowIfInvalid(name,
                    nameof(name)))
                .WithValue(value)
                .Build();
        ...
        /// <summary>
        /// Creates a <see cref="Int64PreferenceBuilder"/> with
        /// <paramref name="name"/> (after it is processed with
        /// <see cref="Preference.ProcessNameOrThrowIfInvalid(string,
        /// string)"/>).
        /// </summary>
        ...
        /// <exception cref="ArgumentNullException"><paramref name="name"/> is
        /// <see langword="null"/>.</exception>
        public static Int64PreferenceBuilder Create(string name)
            => new Int64PreferenceBuilder()
            {
