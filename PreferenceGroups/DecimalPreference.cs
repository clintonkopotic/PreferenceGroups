...
{
    /// <summary>
    /// A <see cref="decimal"/> <see cref="Preference"/>.
    /// </summary>
    public class DecimalPreference : StructPreference<decimal>
    {
        /// <summary>
        ...
        /// method.
        /// </summary>
        /// <param name="name">The name of the <see cref="DecimalPreference"/>
        ...
        public DecimalPreference(string name) : base(name)
        { }
        ...
        /// empty <see langword="string"/> or conists only of white-space
        /// characters.</exception>
        public DecimalPreference(string name, string description,
            bool allowUndefinedValues,
            IEnumerable<decimal?> allowedValues,
            StructValidityProcessor<decimal> validityProcessor)
        ...
        /// characters.</exception>
        public DecimalPreference(string name, string description,
            bool allowUndefinedValues, IEnumerable<decimal?> allowedValues,
        ...
        /// <see cref="decimal"/>. If <paramref name="value"/> is
        ...
        public override decimal? ConvertObjectToValue(object value)
            => ConvertObjectToValueBase(value);

        /// <summary>
        /// Uses <see cref="Convert.ToDecimal(object)"/> to convert
        /// <paramref name="value"/> to a <see cref="Nullable{T}"/> of
        /// <see cref="decimal"/>. If <paramref name="value"/> is
        /// <see langword="null"/>, then <see langword="null"/> is returned.
        /// </summary>
        ...
        /// <exception cref="SetValueException">An exception was thrown while
        /// converting.</exception>
        public static decimal? ConvertObjectToValueBase(object value)
        {
            if (value is null)
            {
                return null;
