...
namespace PreferenceGroups.Tests
{
    ...
    public sealed class EnumPreferenceTests
    {
        ...
        {
            var name = "name";
            EnumPreference<SingleDay> preference = EnumPreferenceBuilder<SingleDay>
                .Create(name)
                .WithValue(SingleDay.Sunday)
                .WithDescription(null)
                .WithDefaultValue(null)
                ...
                .WithValidityProcessor(
                    EnumValueValidityProcessor<SingleDay>.IsDefinedAndNotZero)
                .Build();
            ...
            var exception = Assert.ThrowsException<SetValueException>(() =>
            {
                preference = EnumPreferenceBuilder<SingleDay>
                    ...
                    .WithNoAllowedValues()
                    .WithValidityProcessor(
                        new StructValueValidityProcessor<SingleDay>()
                        {
                            IsValid = dayValue => dayValue != SingleDay.Sunday
                                ? StructValueValidityResult<SingleDay>.IsValid()
                                : StructValueValidityResult<SingleDay>.NotValid(
            ...
            exception = Assert.ThrowsException<SetValueException>(() =>
            {
                preference = EnumPreferenceBuilder<SingleDay>
                    ...
                    .WithNoAllowedValues()
                    .WithValidityProcessor(
                        EnumValueValidityProcessor<SingleDay>
                        .IsDefinedAndNotZero)
                    .Build();
            });
